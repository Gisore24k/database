            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="testimonial__wrap">
                        <div class="section__title">
                            <span class="sub-title">03 - Feedback</span>
                            <h2 class="title">Happy visitors Feedback</h2>
                        </div>
                        <div class="testimonial__active">
                            <div class="testimonial__item">
                                ...
                                <div class="testimonial__content">
                                    <p>May God give us strength and grace to go through to the end. O, won't it be glorious when it is all over and we are with Jesus! <br> {1SC7: 2.8} [45].</p>
                                    <div class="testimonial__avatar">
                                        <span>Mrs. Faith Pruett</span>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial__item">
                                ...
                                <div class="testimonial__content">
                                    <p>We thank God that He mercifully gave us willingness and courage to read and investigate for ourselves after we had set our hearts against His message. Praises be to Him for His goodness and for present truth. We expect to put ourselves and our all into this work.</p>
                                    <div class="testimonial__avatar">
                                        <span>Mr. & Mrs. C.E. Wessel</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            ...
                            <div class="blog__post__tags">
                                <a href="blog.html">Story of The Redemption </a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">8 May 2025</span>
                            <h3 class="title"><a href="blog-details.html">Three Angels Message</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            ...
                            <div class="blog__post__tags">
                                <a href="blog.html">The Judgements</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">8 May 2025</span>
                            <h3 class="title"><a href="blog-details.html">Judgement of the Dead and the Living.</a></h3>
                            <a href="blog-details.html" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-9">
                    <div class="blog__post__item">
                        <div class="blog__post__thumb">
                            ...
                            <div class="blog__post__tags">
                                <a href="blog.html">Steps To Christ</a>
                            </div>
                        </div>
                        <div class="blog__post__content">
                            <span class="date">8 May 2025</span>
                            <h3 class="title"><a href="blog-details.html">How to grow Spiritually</a></h3>
                            <a href="blog-details.html" class="read__more">Read mORe</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="homeContact__wrap">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section__title">
                            <span class="sub-title">04 - Contacr Us</span>
                            <h2 class="title">Any questions? Feel free <br> to contact Us</h2>
                        </div>
                        <div class="homeContact__content">
                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form</p>
                            <h2 class="mail"><a href="mailto:Info@webmail.com">Info@gadsda.com</a></h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
